  ...
  <div>
    <div class="toolbar">
      ...
      <div class="toolbar-btn-group">
        <el-button type="primary" @click="$router.push({ name: 'NewsInfo' })"
          >添加</el-button
        >
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    editHandle(row) {
      this.$router.push({ name: "NewsInfo", query: { id: row.id } });
    },
    deleteHandle(row) {
      this.$confirm("确认是否删除新闻数据?", "提示", {
